...
namespace DiriJournal.Services
{
    public class HomePageDataService
    {
        ...
        public HomePageDataService(IConfiguration configuration, ServiceClient serviceClient)
        {
        ...
        public async Task<List<BannerText>> GetHomePageBannerData()
        {
            ...
            retrunString = await _serviceClient.clientMethod(_configuration.GetSection("ApiEndpoints").GetSection("BaseAddress").Value + $"HomePage/GetHomePageBanner");
        ...
        public async Task<NumericDashboard> GetNumericDashboardData()
        {
            ...
            string retrunString = null;
            retrunString = await _serviceClient.clientMethod(_configuration.GetSection("ApiEndpoints").GetSection("BaseAddress").Value + $"HomePage/GetNumericDashboard");
        ...
        public async Task<AboutU> GetAboutUsSummary()
        {
            ...
            aboutUs = new();
            string retrunString = null;
            retrunString = await _serviceClient.clientMethod(_configuration.GetSection("ApiEndpoints").GetSection("BaseAddress").Value + $"HomePage/GeAboutUsSummary");
        ...
        {            
            ...
            string retrunString = null;
            retrunString = await _serviceClient.clientMethod(_configuration.GetSection("ApiEndpoints").GetSection("BaseAddress").Value + $"HomePage/GetFounderInfo");
        ...
        public async Task<ManagingTrusteeInfo> GetManagingTrusteeInfo()
        {
            ...
            string retrunString = null;
            retrunString = await _serviceClient.clientMethod(_configuration.GetSection("ApiEndpoints").GetSection("BaseAddress").Value + $"HomePage/GetManagingTrusteeInfo");
        ...
        public async Task<HighlightedEvent> GetHighlightedEvent()
        {
            ...
            string retrunString = null;
            retrunString = await _serviceClient.clientMethod(_configuration.GetSection("ApiEndpoints").GetSection("BaseAddress").Value + $"HomePage/GetHighlightedEvent");
        ...
        public async Task<ContactU> GetOrganizationalData()
        {
            contactUs = new();
            string retrunString = null;
            retrunString = await _serviceClient.clientMethod(_configuration.GetSection("ApiEndpoints").GetSection("BaseAddress").Value + $"HomePage/GetContactUsData");
